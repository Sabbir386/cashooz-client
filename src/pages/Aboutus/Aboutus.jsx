        ...
        <section className="mt-8">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              Leaderboards simply display the position of users based on their
              score. The higher a user’s score the higher up on whichever
              leaderboard they may be seen on. A user’s score comes from how
              many tasks they complete correct on the very first attempt. Every
              task that is completed correct grants points. Cashooz is giving
              monthly two types leaderboard prize. Top task completion prize &
              top affiliate prize.
            </p>
          </div>
          {/* main point */}
          ...
          <div className="pl-4">
            ...
            <p className="text-gray-400 leading-relaxed mb-4 text-xs">
              ...
              month. You have the opportunity to win the cash prize offered by
              Cashooz each month. Therefore, do not delay; begin your earning
              journey now. Join for free here.
            </p>
          </div>
          {/* small points  */}
          {/* main point */}
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              self-service advertising options. Our team is dedicated to
              developing customized solutions that align with your brand's
              specific objectives and enhance your return on advertising spend.
              We will leverage our extensive network of qualified, expert
              affiliates to present your product or service to new, targeted
              audiences. You will only incur costs for actions that are
              significant to your business, whether those are sales, sign-ups,
              installations, or any other metrics you consider vital for its
              growth.
            </p>
          </div>
          {/* main point */}
          ...
          <div className="pl-4">
            ...
            <p className="text-gray-400 leading-relaxed mb-4 text-xs">
              ...
              budget and objectives, subsequently crafting a campaign tailored
              to achieve those objectives. Your account manager will assist you
              in launching your campaign and will remain engaged to ensure its
              success. Allow us to craft a unique performance marketing strategy
              that your brand truly deserves.
            </p>
          </div>
          {/* small points  */}
          {/* main point */}
