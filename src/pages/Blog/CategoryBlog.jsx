            ...
            >
              ...
              <div className="md:w-1/2 w-full">
                <img
                  ...
                  alt="Blog Visual"
                  className="w-full h-52 object-cover rounded-t-2xl md:rounded-l-2xl md:rounded-t-none"
                />
              </div>
              ...
              <div className="md:w-1/2 w-full p-6 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-3">
                    Back in 2019, Gucci brought video games to its app with a
                    new section called Gucci Arcade,
                  </p>
                </div>
              </div>
            </Link>
